  ...
  },
  {
    ...
    questoes: [
      ...
      },
      {
        ...
        naoPontuavel: true,
        hasNaOption: true,
        dica: 'Questão de registro/diligência: NÃO altera a pontuação do Eixo 2 (a regra do máximo absorve o item; a enforcement quantitativa fica na Versão B). Aplicável quando o sistema é adaptativo (1.2 = Sim); marque "Não se aplica" quando 1.2 = Não. O plano de novo consentimento — com limiar de mudança definido, procedimento e responsável — é exigência para sistemas que mudam de comportamento durante o estudo (Lei n.º 14.874/2024 — consentimento prévio; LGPD — autodeterminação informativa). Terminologia: "novo consentimento", não "re-consentimento".',
      },
    ],
  },
  {
