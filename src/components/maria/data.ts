...
export const QUALITATIVE_AXES: QualitativeAxis[] = [
  ...
  // Regra de elevação: 0 → não eleva; 1-2 → III; 3+ → IV. Eliminatório em 3.b.2.
  {
    ...
    questoes: [
      ...
      {
        id: '3.b.2',
        pergunta: 'Se o banco foi constituído fora do âmbito de pesquisa (origem não-investigativa: prontuários, registros, bases administrativas): há Termo de Anuência Institucional (Art. 27, VI da Res. CNS n.º 738/2024) assinado pelo dirigente/responsável da instituição detentora dos dados?',
        riskAnswer: 'nao',
        eliminatorio: true,
        hasNaOption: true,
        dica: 'Verifica o Termo de Anuência Institucional (Art. 27, VI da Res. CNS n.º 738/2024), assinado pelo responsável da instituição de onde os dados provêm — exigível apenas para banco constituído fora do âmbito de pesquisa (origem não-investigativa: prontuários, registros, bases administrativas). Salvaguarda de Inavaliabilidade: nesse caso, sua ausência torna o protocolo "não avaliável pela MARIA" (§7.3.6), sobrescrevendo a pontuação e exigindo análise individualizada do CEP. Marque "Não se aplica" quando o banco foi constituído no âmbito de pesquisa — inclusive reuso de banco de pesquisa anterior do próprio pesquisador —, hipótese regida pelo Art. 24 (Termo de Compromisso de Uso de Dados), que não exige Anuência.',
      },
      {
        id: '3.b.3',
        ...
        riskAnswer: 'nao',
        dica: 'Confirma o Termo de Compromisso de Uso de Dados, assinado pelos pesquisadores (Arts. 24, V e 27, V da Res. CNS n.º 738/2024), que assumem responsabilidade sobre finalidade, confidencialidade e descarte. É distinto do Termo de Anuência (3.b.2): o Compromisso é dos pesquisadores; a Anuência, do dirigente da instituição detentora. No Eixo 3.b, uma única resposta de risco já eleva o eixo ao Nível III.',
      },
      {
        id: '3.b.4',
